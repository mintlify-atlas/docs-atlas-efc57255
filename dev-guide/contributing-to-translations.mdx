...
OpenRocket is translated into multiple languages. Translations are stored as Java `.properties` files in the repository and synchronized with [Crowdin](https://crowdin.com/project/openrocket), an online translation platform. You can contribute translations either directly via Crowdin or by editing the `.properties` files in the repository.
